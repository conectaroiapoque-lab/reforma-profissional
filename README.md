...
O atendimento central é pelo telefone **(31) 2510-2500**. O botão de WhatsApp usa o número `5531990102500`, configurado na constante `WHATSAPP_NUMBER`, no início de `app.js`, e abre a conversa com a mensagem: “Olá, vim pelo app Reforma Profissional e quero solicitar um serviço.”
